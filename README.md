...
[Rule details](https://github.com/StyleList94/eslint-config-stylish/blob/main/rules/base.js)
...
[Rule details](https://github.com/StyleList94/eslint-config-stylish/blob/main/rules/base.js#L169)
...
[Rule details](https://github.com/StyleList94/eslint-config-stylish/blob/main/rules/import.js)
...
[Rule details](https://github.com/StyleList94/eslint-config-stylish/blob/main/rules/react.js)
...
[Rule details](https://github.com/StyleList94/eslint-config-stylish/blob/main/rules/react-hooks.js)
...
[Rule details](https://github.com/StyleList94/eslint-config-stylish/blob/main/rules/jsx-a11y.js)
...
[Rule details](https://github.com/StyleList94/eslint-config-stylish/blob/main/rules/typescript.js)
...
[Rule details](https://github.com/StyleList94/eslint-config-stylish/blob/main/rules/typescript.js#L108)

- [`@typescript-eslint/adjacent-overload-signatures`](https://typescript-eslint.io/rules/adjacent-overload-signatures/): `error`
- [`@typescript-eslint/array-type`](https://typescript-eslint.io/rules/array-type/): `error`
- [`@typescript-eslint/ban-tslint-comment`](https://typescript-eslint.io/rules/ban-tslint-comment/): `error`
- [`@typescript-eslint/consistent-generic-constructors`](https://typescript-eslint.io/rules/consistent-generic-constructors/): `error`
- [`@typescript-eslint/consistent-indexed-object-style`](https://typescript-eslint.io/rules/consistent-indexed-object-style/): `error`
- [`@typescript-eslint/consistent-type-assertions`](https://typescript-eslint.io/rules/consistent-type-assertions/): `error`
- [`@typescript-eslint/dot-notation`](https://typescript-eslint.io/rules/dot-notation): `error` (extends `dot-notation`)
- [`@typescript-eslint/no-confusing-non-null-assertion`](https://typescript-eslint.io/rules/no-confusing-non-null-assertion/): `error`
- [`@typescript-eslint/no-empty-function`](https://typescript-eslint.io/rules/no-empty-function): `error` (extends `no-empty-function`)
- [`@typescript-eslint/no-inferrable-types`](https://typescript-eslint.io/rules/no-inferrable-types/): `error`
- [`@typescript-eslint/prefer-find`](https://typescript-eslint.io/rules/prefer-find/): `error`
- [`@typescript-eslint/prefer-for-of`](https://typescript-eslint.io/rules/prefer-for-of/): `error`
- [`@typescript-eslint/prefer-function-type`](https://typescript-eslint.io/rules/prefer-function-type/): `error`
- [`@typescript-eslint/prefer-includes`](https://typescript-eslint.io/rules/prefer-includes/): `error`
- [`@typescript-eslint/prefer-nullish-coalescing`](https://typescript-eslint.io/rules/prefer-nullish-coalescing/): `error`
- [`@typescript-eslint/prefer-optional-chain`](https://typescript-eslint.io/rules/prefer-optional-chain/): `error`
- [`@typescript-eslint/prefer-regexp-exec`](https://typescript-eslint.io/rules/prefer-regexp-exec/): `error`
- [`@typescript-eslint/prefer-string-starts-ends-with`](https://typescript-eslint.io/rules/prefer-string-starts-ends-with/): `error`
